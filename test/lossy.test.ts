...
describe("attributes", () => {
  ...
  it("element with attributes and element-only children", () => {
    expect(
      lossy('<root lang="en"><a>1</a><b>2</b></root>'),
    ).toMatchSnapshot();
  });
});
...
describe("repeated siblings", () => {
  ...
  it("mixed repeated and unique siblings", () => {
    expect(
      lossy("<root><a>1</a><b>X</b><a>2</a></root>"),
    ).toMatchSnapshot();
  });
});
...
describe("processing instructions", () => {
  it("xml declaration is filtered at top level", () => {
    expect(
      lossy('<?xml version="1.0"?><root>text</root>'),
    ).toMatchSnapshot();
  });
});
...
describe("HTML mode", () => {
  ...
  it("img with attributes", () => {
    expect(
      lossy(
        '<div><img src="x.png" alt="photo"><span>caption</span></div>',
        { html: true },
      ),
    ).toMatchSnapshot();
  });
