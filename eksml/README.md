...
- **SAX streaming**: 1.3-1.6x faster than easysax, 1.8-3.4x faster than htmlparser2/saxes, 4-6x faster than sax
- **Raw tokenization**: 1.1-1.6x faster than easysax, 1.9-4.7x faster than saxes/htmlparser2, 4-10x faster than sax
