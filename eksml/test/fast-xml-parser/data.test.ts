...
describe('mixed data (from data_spec)', () => {
  ...
  it("should parse attributes having '>' in value", () => {
    ...
    expect(result.testStep.$name).toBe('test step name (bankId -> Error)');
    expect(result.testStep.$id).toBe('90e453d3-30cd-4958-a3be-61ecfe7a7cbe');
...
\t</Period>
    ...
    const result = lossy(xmlData) as any;
    expect(result.MPD.$availabilityStartTime).toBe('2020-02-16T10:52:03.119Z');
